...
(function buildClients() {
  const clients = [
    { name: 'ICompany',       icon: 'fas fa-laptop-code' },
    { name: 'PolicyBazaar',   icon: 'fas fa-shield-alt' },
    { name: 'Socomec',        icon: 'fas fa-bolt' },
    { name: 'Airtel',         icon: 'fas fa-wifi' },
    { name: 'Bacardi',        icon: 'fas fa-glass-martini-alt' },
    { name: 'DHFL',           icon: 'fas fa-home' },
    { name: 'Red Bull',       icon: 'fas fa-tint' },
    { name: 'TISCO',          icon: 'fas fa-industry' },
    { name: 'Antalis',        icon: 'fas fa-file-alt' },
    { name: 'BNI',            icon: 'fas fa-handshake' },
    { name: 'Orient',         icon: 'fas fa-fan' },
    { name: 'Fortis',         icon: 'fas fa-hospital' },
    { name: 'TATA',           icon: 'fas fa-car' },
    { name: 'Amplifon',       icon: 'fas fa-assistive-listening-systems' },
    { name: 'Reddlife',       icon: 'fas fa-heartbeat' },
    { name: 'DRDO',           icon: 'fas fa-rocket' },
    { name: 'Red FM',         icon: 'fas fa-broadcast-tower' },
    { name: 'Café Coffee Day',icon: 'fas fa-coffee' },
  ];
